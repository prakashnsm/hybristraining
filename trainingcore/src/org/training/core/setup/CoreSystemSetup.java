...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	private class ImportCatalogAwareDataStrategy
	{
		...
		private void createAndActivateSolrIndex(final String storeName)
		{
			...
			importImpexFile(context, "/trainingcore/import/stores/" + storeName + "/solr.impex");

			createSolrIndexerCronJobs(storeName + "Index");

			importImpexFile(context, "/trainingcore/import/stores/" + storeName + "/solrtrigger.impex");
		...
		private void createStore(final String storeName)
		{
			...
			importImpexFile(context, "/trainingcore/import/stores/" + storeName + "/store.impex");
			importImpexFile(context, "/trainingcore/import/stores/" + storeName + "/site.impex");
		...
		private void createContentCatalog(final String contentCatalogName)
		{
			...
			importImpexFile(context, "/trainingcore/import/contentCatalogs/" + contentCatalogName
					+ "ContentCatalog/catalog.impex", true);
			importImpexFile(context, "/trainingcore/import/contentCatalogs/" + contentCatalogName
		...
		private void createProductCatalog(final String productCatalogName)
		{
			...
			importImpexFile(context, "/trainingcore/import/productCatalogs/" + productCatalogName
					+ "ProductCatalog/catalog.impex", true);
