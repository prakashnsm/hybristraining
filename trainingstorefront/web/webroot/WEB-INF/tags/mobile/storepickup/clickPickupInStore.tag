...
<div id="popup_store_pickup_form_product_${product.code}${entryNumber}" class="pickup_store_search" style="display:none">
	...
	<div class="span-17 last">
		<div class="pickup_store_search-form">
			<form name="pickupInStoreForm" action="${pickupInStoreUrl}" method="post" id="pickup_in_store_search_form_product_${product.code}${entryNumber}" class="form_field-input">
