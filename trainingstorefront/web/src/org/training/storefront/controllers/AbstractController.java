...
public abstract class AbstractController
{
	...
	/**
	 * Helper method to lookup a spring bean in the context of a request. This should only be used to lookup
	 * beans that are request scoped. The looked up bean is cached in the request attributes so it should
	 * not have a narrower scope than request scope. This method should not be used for beans that could
	 * be injected into this bean.
	 *
	 * @param request the current request
	 * @param beanName the name of the bean to lookup
	 * @param beanType the expected type of the bean
