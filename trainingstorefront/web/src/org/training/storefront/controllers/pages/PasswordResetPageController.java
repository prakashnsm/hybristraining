...
import org.training.storefront.forms.ForgottenPwdForm;
...
/**
 * Controller for the forgotten password pages. Supports requesting a password reset email as well as changing the password once
 * you have got the token that was sent via email.
 */
@Controller
@Scope("tenant")
...
public class PasswordResetPageController extends AbstractPageController
{
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		if (!StringUtils.isBlank(form.getToken()))
		{
			...
			{
				GlobalMessages
						.addFlashMessage(redirectModel, GlobalMessages.ERROR_MESSAGES_HOLDER, "updatePwd.token.invalidated");
			}
