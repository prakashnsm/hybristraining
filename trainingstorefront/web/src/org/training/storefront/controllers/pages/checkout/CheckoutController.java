...
import org.training.storefront.forms.GuestRegisterForm;
import org.training.storefront.forms.validation.GuestRegisterValidator;
...
public class CheckoutController extends AbstractCheckoutController
{
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		{
			processOrderCode(form.getOrderCode(), model, request);
