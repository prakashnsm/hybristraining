...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "traininginitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "traininginitialdata", "yaccelerator", "yaccelerator", Collections.singletonList("yaccelerator"));

		if (getBooleanSystemSetupParameter(context, IMPORT_SAMPLE_DATA))
		{
			importCommonData(context, SAMPLE_DATA_IMPORT_FOLDER);

			// Import the product data for each catalog
			importProductCatalog(context, SAMPLE_DATA_IMPORT_FOLDER, "electronics");
			importProductCatalog(context, SAMPLE_DATA_IMPORT_FOLDER, "apparel");

			// Import the content catalogs for each site
			importContentCatalog(context, SAMPLE_DATA_IMPORT_FOLDER, "electronics");
			importContentCatalog(context, SAMPLE_DATA_IMPORT_FOLDER, "apparel-uk");
			importContentCatalog(context, SAMPLE_DATA_IMPORT_FOLDER, "apparel-de");

			// Import the store locations
			importStoreLocations(context, SAMPLE_DATA_IMPORT_FOLDER, "electronics");
			importStoreLocations(context, SAMPLE_DATA_IMPORT_FOLDER, "apparel-uk");
			importStoreLocations(context, SAMPLE_DATA_IMPORT_FOLDER, "apparel-de");
			...
			apparelImportData.setContentCatalogNames(Arrays.asList("apparel-uk", "apparel-de"));
			apparelImportData.setStoreNames(Arrays.asList("apparel-uk", "apparel-de"));
			...
			getEventService().publishEvent(
					new SampleDataImportedEvent(context, Arrays.asList(electronicsImportData, apparelImportData)));
		}
	}
